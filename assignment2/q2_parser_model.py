...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.etaregularization_placeholder=tf.placeholder(tf.float32)
        ### END YOUR CODE

    def create_feed_dict(self, inputs_batch, labels_batch=None, dropout=1, etaregularization=0.1):
        ...
        """
        ### YOUR CODE HERE
        feed_dict={self.input_placeholder:inputs_batch,self.dropout_placeholder:dropout,self.etaregularization_placeholder:etaregularization}
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss_all=tf.nn.softmax_cross_entropy_with_logits(logits=pred,labels=self.labels_placeholder)
        loss_all+=self.etaregularization_placeholder*tf.nn.l2_loss(self.w)
