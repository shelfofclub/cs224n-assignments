...
def minibatch_parse(sentences, model, batch_size):
    ...
    while len(unfinished_parses)>0:
        ...
        # completed_index=[i for i in xrange(len(unfinished_parses)) if (len(unfinished_parses[i].stack)<=1 and len(unfinished_parses[i].buffer)<=0)]
        # completed_index.reverse()
        # for i in completed_index:
